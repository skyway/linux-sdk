...
public:
    ...
    virtual std::optional<model::Channel> FindOrCreateChannel(const model::Channel::Init& init) = 0;

    virtual std::optional<model::Channel> GetChannel(const std::string& channel_id) = 0;
    virtual std::optional<model::Channel> GetChannelByName(const std::string& name) = 0;
    ...
    virtual std::optional<rpc::dto::JoinChannelResult> AddMember(
    ...
    virtual std::optional<rpc::dto::PublishStreamResult> PublishStream(
    ...
    virtual bool DisablePublication(const std::string& channel_id,
                                    const std::string& publication_id)  = 0;
    virtual std::optional<rpc::dto::SubscribeStreamResult> SubscribeStream(
